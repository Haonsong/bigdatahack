...
d3.csv('data/Data_ver2.0.csv', function (error, data) {

  var root = { "key": "number", "values": d3.nest()
    .key(function(d) { return d.course_major; })
    .key(function(d) { return d.course_number; })
    .key(function(d) { return d.major_name; })
    .rollup(function(leaves) { return d3.sum(leaves, function(d) { return +d.weight; }); })  //ADDED: coerce text value to number;
    .entries(data)
  };
